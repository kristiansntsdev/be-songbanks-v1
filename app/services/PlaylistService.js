...
class PlaylistService {
    ...
    static async generateShareableLink(playlistId, userId) {
        ...
        let playlistTeam = playlist.playlist_team_id ? 
            await PlaylistTeam.findByPk(playlist.playlist_team_id) : null;
    ...
    static async joinPlaylistViaLink(shareToken, userId) {
        ...
        if (playlist.is_locked) {
            throw new Error('This playlist is locked and no longer accepting new members via link');
        }
    ...
    static async getSharedPlaylistDetails(shareToken) {
        ...
        return {
            ...
            songs: playlist.songs.sort((a, b) => 
                a.playlist_songs.order_index - b.playlist_songs.order_index
            ),
