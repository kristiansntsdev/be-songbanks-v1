...
class PlaylistTeamController {
    ...
    static createPlaylistTeam = ErrorHandler.asyncHandler(async (req, res) => {
        const team = await PlaylistTeamService.createPlaylistTeam(req.body, req.user.id);
    ...
    static updatePlaylistTeam = ErrorHandler.asyncHandler(async (req, res) => {
        const team = await PlaylistTeamService.updatePlaylistTeam(req.params.id, req.body, req.user.id);
    ...
    static addMemberToTeam = ErrorHandler.asyncHandler(async (req, res) => {
        ...
        await PlaylistTeamService.addMemberToTeam(teamId, memberId, role, req.user.id);
    ...
    static removeMemberFromTeam = ErrorHandler.asyncHandler(async (req, res) => {
        ...
        await PlaylistTeamService.removeMemberFromTeam(teamId, memberId, req.user.id);
    ...
    static updateMemberRole = ErrorHandler.asyncHandler(async (req, res) => {
        ...
        await PlaylistTeamService.updateMemberRole(teamId, memberId, role, req.user.id);
    ...
    static inviteMemberToTeam = ErrorHandler.asyncHandler(async (req, res) => {
        ...
        const result = await PlaylistTeamService.inviteMemberToTeam(teamId, user_email, role, req.user.id);
    ...
    static updateTeamVisibility = ErrorHandler.asyncHandler(async (req, res) => {
        ...
        const result = await PlaylistTeamService.updateTeamVisibility(teamId, is_hidden, req.user.id);
