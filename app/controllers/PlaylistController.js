...
class PlaylistController {
    ...
    static updatePlaylist = ErrorHandler.asyncHandler(async (req, res) => {
        const playlist = await PlaylistService.updatePlaylist(req.params.id, req.body, req.user.id);
    ...
    static addSongToPlaylist = ErrorHandler.asyncHandler(async (req, res) => {
        ...
        await PlaylistService.addSongToPlaylist(playlistId, songId, order_index, req.user.id);
     ...
     * @returns {message: string}
     */
    static removeSongFromPlaylist = ErrorHandler.asyncHandler(async (req, res) => {
        const { id: playlistId, song_id: songId } = req.params;
        
        await PlaylistService.removeSongFromPlaylist(playlistId, songId, req.user.id);
    ...
    static generateShareableLink = ErrorHandler.asyncHandler(async (req, res) => {
        ...
        const result = await PlaylistService.generateShareableLink(playlistId, req.user.id);
    ...
    static joinPlaylistViaLink = ErrorHandler.asyncHandler(async (req, res) => {
        ...
        const result = await PlaylistService.joinPlaylistViaLink(shareToken, req.user.id);
     ...
     * @returns {playlist: object}
     */
    static getSharedPlaylistDetails = ErrorHandler.asyncHandler(async (req, res) => {
        const { share_token: shareToken } = req.params;
        
        const playlist = await PlaylistService.getSharedPlaylistDetails(shareToken);
