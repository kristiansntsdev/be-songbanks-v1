...
class Schema {
    ...
    async create(tableName, callback) {
        const blueprint = new Blueprint(tableName, this.queryInterface, this.Sequelize);
    ...
    async table(tableName, callback) {
        ...
        console.warn('Schema.table() is not fully implemented yet. Use queryInterface directly for table modifications.');
    }
