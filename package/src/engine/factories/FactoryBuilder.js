...
class FactoryBuilder {
        ...
        const factoryClass = class extends Factory {
            definition() {
                ...
                for (const [key, value] of Object.entries(definition)) {
                    if (typeof value === 'function' && value.name && FactoryTypes[value.name]) {
    ...
    resolveModel(modelName) {
        ...
        try {
            ...
            throw new Error(`Could not resolve model ${modelName}. Register a resolver or ensure the model exists at app/models/${modelName}.js`);
        }
    }
...
module.exports = {
    ...
    define: (modelName, definition) => factoryBuilder.define(modelName, definition),
    factory: (modelName, count) => factoryBuilder.factory(modelName, count),
    state: (modelName, stateName, definition) => factoryBuilder.state(modelName, stateName, definition),
