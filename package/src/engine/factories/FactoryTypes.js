...
class FactoryTypes {
    ...
    static nullable(generator, probability = 0.5) {
        return faker.datatype.boolean(probability) ? null : 
    ...
    static optional(generator, probability = 0.8) {
        return faker.datatype.boolean(probability) ? 
            (typeof generator === 'function' ? generator() : generator) : undefined;
    }

    // Generic category generators
    static category() {
        return this.randomElement([
            'Primary', 'Secondary', 'Featured', 'Special', 'Standard', 'Premium',
            'Basic', 'Advanced', 'Popular', 'Trending', 'New', 'Classic'
        ]);
    }

    static status() {
        return this.randomElement(['active', 'inactive', 'pending', 'suspended', 'archived']);
    }
    ...
    static type() {
        return this.randomElement(['type_a', 'type_b', 'type_c', 'standard', 'custom']);
    }

    static role() {
        return this.randomElement(['admin', 'user', 'moderator', 'guest', 'member']);
    }
    ...
    static level() {
        return this.randomElement(['beginner', 'intermediate', 'advanced', 'expert']);
    }
    ...
    static title() {
        return this.words(3).split(' ').map(word => 
