...
class SongFactory extends Factory {
    ...
    definition() {
        return {
            ...
            base_chord: FactoryTypes.randomElement(['C', 'G', 'Am', 'F', 'D', 'Em', 'A', 'Dm', 'E', 'Bm']),
    ...
    rock() {
        return this.state({
            artist: FactoryTypes.randomElement(['AC/DC', 'Led Zeppelin', 'Queen', 'The Beatles']),
    ...
    folk() {
        return this.state({
            artist: FactoryTypes.randomElement(['Bob Dylan', 'Joni Mitchell', 'Neil Young', 'Joan Baez']),
    ...
    gospel() {
        return this.state({
            artist: FactoryTypes.randomElement(['Mahalia Jackson', 'Kirk Franklin', 'CeCe Winans']),
    ...
    blues() {
        return this.state({
            artist: FactoryTypes.randomElement(['B.B. King', 'Muddy Waters', 'Robert Johnson']),
    ...
    country() {
        return this.state({
            artist: FactoryTypes.randomElement(['Johnny Cash', 'Dolly Parton', 'Hank Williams']),
