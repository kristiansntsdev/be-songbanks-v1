...
router.post('/playlists/:id/sharelink', authenticateToken, PlaylistController.generateSharelink);
router.post('/playlists/join/:shareToken', authenticateToken, PlaylistController.joinPlaylistViaSharelink);
router.post('/playlists/:id/songs', authenticateToken, PlaylistController.addSongToPlaylist);
router.post('/playlists/:id/songs/:songId', authenticateToken, PlaylistController.addSongToPlaylistWithBaseChord);
router.delete('/playlists/:id/song/:songId', authenticateToken, PlaylistController.removeSongFromPlaylist);

// PlaylistTeamController Routes
router.get('/playlist-teams', authenticateToken, PlaylistTeamController.getAllPlaylistTeamsByUserId);
router.get('/playlist-teams/:id', authenticateToken, PlaylistTeamController.getPlaylistTeamById);
router.delete('/playlist-teams/:id/members/:user_id', authenticateToken, PlaylistTeamController.removeMemberFromTeam);
router.delete('/playlist-teams/:id', authenticateToken, PlaylistTeamController.deletePlaylistTeam);
router.post('/playlist-teams/:id/leave', authenticateToken, PlaylistTeamController.leavePlaylistTeam);
